...
export default function ProgramSharePage() {
  ...
  const downloadInfo = () => {
    ...
    const lines = [
      ...
      program.mobile_number ? `मोबाइल: ${program.mobile_number}` : "",
              ...
              <div className="rounded-2xl border border-green-200 bg-green-50 p-4">
                ...
                <div className="mt-2 flex flex-col gap-2 sm:flex-row sm:items-center">
                  <a
                    ...
                    className="flex-1 rounded-xl bg-white border border-green-300 px-4 py-3 font-bold text-green-700 hover:bg-green-100 active:bg-green-100"
                    title="मोबाइल नंबर पर कॉल करें"
                  >
                    📞 {program.mobile_number}
                  </a>
                  <button
                    ...
                    onClick={async () => {
                      try {
                        await navigator.clipboard.writeText(program.mobile_number || "");
                        window.alert("मोबाइल नंबर कॉपी हो गया।");
                      } catch {
                        window.prompt("मोबाइल नंबर कॉपी करें:", program.mobile_number || "");
                      }
                    }}
                    className="rounded-xl border border-blue-300 bg-white px-4 py-3 font-bold text-blue-700 hover:bg-blue-50"
